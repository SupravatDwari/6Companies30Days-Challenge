...
class Solution {
    ...
    private List<Integer> findPath(int start, int target) {
    ...
    private boolean visit(int node, int target, List<Integer> path, boolean[] visited) {
        if (node == target) {
            path.add(node);
            return true;
        }
...
/* Submission Link : https://leetcode.com/problems/most-profitable-path-in-a-tree/submissions/874807474/ */
